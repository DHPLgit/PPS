	...
	<div class="container">
		...
		<div class="title-head">
          ...
          <button type="button" id="reset"> Reset</button>
			...
			<div class="text-center"><a class="crt-sur float-end" href="<?php echo site_url('/taskDetail/deptMap'); ?>">Create Department</a>
			</div>
		</div>
		<div class="mt-3">
					...
					<tbody>
						...
						foreach ($deptList as $dept) {
							...
							<tr id="task-det-row">
								...
								<td>
									<?php echo stripslashes($count); ?>
								</td>
								<td style="display:none;">
									<?php echo stripslashes($dept['dept_id']); ?>
								</td>
								<td>
									<?php echo stripslashes($dept['dept_name']); ?>
								</td>
		...
		<div class="modal fade" id="departmentEditModal">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<form action="<?= base_url('department/updateDepartment') ?>" class="form" id="updateDepartmentForm" method="post">
						<div class="modal-body ctr-segment-body" style="padding:20px;">
							...
							<br />
							<div class="d-grid">
								<button type="submit" class="btn btn-success confirm pull-right"><span class="fa fa-edit"></span>
									Save</button>
